...
1. Clone the repo:
   ```sh
   git clone https://github.com/Samudralapradeep/Job-portal.git
   ```
...
Pradeep Samudrala - [GitHub](https://github.com/Samudralapradeep)

Project Link: [https://github.com/Samudralapradeep/Job-portal.git](https://github.com/Samudralapradeep/Job-portal.git)
